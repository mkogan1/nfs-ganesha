		       ...
		       struct kmip_host_param *host_p)
{
	...
	// clang-format off
// SIZEOF v is an operator; omitting () is an antibug pattern ! ! !
#define SizeofVar size ## of
	// clang-format on
	snprintf(portstring, SizeofVar portstring, "%d", host_p->port);
			     ...
			     struct fsal_obj_handle *obj)
{
	...
	struct gsh_export *export = cb->export_;
