...
struct gsh_export {
	...
	/** List of callbacks to made made once the root is set */
	...
	struct QoS_perExport_Class *qos_class;
#endif
...
void add_to_export_callbacks(struct gsh_export *,
	struct exp_root_callback_sw *, struct exp_root_callback *);
...
struct export_extension_sw {
	int (*load)(struct export_extension *,
